...
from docutils_asciidoc.utils import expand_leading_tabs

if TYPE_CHECKING:
    from docutils_asciidoc.inlineparser.list_processors import ListProcessor
