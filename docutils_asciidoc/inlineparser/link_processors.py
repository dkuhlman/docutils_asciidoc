"""
    docutils_asciidoc.inlineparser.link_processors
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
from docutils_asciidoc import addnodes
from docutils_asciidoc.inlineparser import PatternInlineProcessor, backtrack_onerror
from docutils_asciidoc.readers import TextReader
from docutils_asciidoc.utils import entitytrans, normalize_uri
from docutils_asciidoc.utils import (
...
class LinkCloserProcessor(PatternInlineProcessor):
    ...
    def process_link_or_image(self, reader: TextReader, document: Element) -> bool:
        ...
        node: Element = None
        if opener['marker'] == '![':
            from docutils_asciidoc.transforms import EmphasisConverter  # lazy loading
